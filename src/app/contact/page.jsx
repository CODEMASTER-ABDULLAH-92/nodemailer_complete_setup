...
//   return (
//     <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#fdfcfb] via-[#f9f7f6] to-[#e6e1dc] px-4">
//       <div className="bg-white/70 backdrop-blur-xl shadow-2xl rounded-3xl p-8 md:p-12 w-full max-w-lg border border-gray-200">
...
//             className="border border-gray-300 rounded-xl p-3 focus:ring-2 focus:ring-blue-400 focus:outline-none transition"
//             required
//           />
//           <input
//             type="email"
...
//           <button
//             type="submit"
//             className="flex items-center justify-center gap-2 bg-blue-600 text-white font-semibold py-3 rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-xl transition transform hover:-translate-y-0.5"
//           >
